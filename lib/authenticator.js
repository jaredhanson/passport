...
Authenticator.prototype.init = function() {
  this.protocol(require('./protocol/www'));
...
Authenticator.prototype.protocol = function(proto) {
...
Authenticator.prototype.initialize = function(options) {
  options = options || {};
  // TODO: Remove _userProperty from here
  this._userProperty = options.userProperty || 'user';
  
  if (this._sm._userProperty) {
    this._userProperty = options.userProperty || 'user';
  }
  
  var session = this._strategies['session'];
  if (session && session._userProperty) {
    session._userProperty = options.userProperty || 'user';
  }
