...
/**
 * Register strategy for use when authenticating requests.
 *
 * This function registers a strategy for later use when authenticating
 * requests.  The name with which the strategy is registered is passed to
