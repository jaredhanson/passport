...
describe('middleware/authenticate', function() {
  ...
  describe('success with flash message set by route as string', function() {
    function Strategy() {
    }
  ...
  describe('success with flash message set by route using options', function() {
    function Strategy() {
    }
    Strategy.prototype.authenticate = function(req, options) {
      var user = { id: '1', username: 'jaredhanson' };
  ...
  describe('success with flash message and type set by route using options', function() {
    function Strategy() {
    }
    Strategy.prototype.authenticate = function(req, options) {
      var user = { id: '1', username: 'jaredhanson' };
  ...
  describe('success with flash message set by strategy', function() {
    function Strategy() {
    }
    Strategy.prototype.authenticate = function(req, options) {
      var user = { id: '1', username: 'jaredhanson' };
  ...
  describe('success with flash message set by strategy and type set by route', function() {
    function Strategy() {
    }
    Strategy.prototype.authenticate = function(req, options) {
      var user = { id: '1', username: 'jaredhanson' };
  ...
  describe('success with flash message and type set by strategy but message overridden by route as string', function() {
    function Strategy() {
    }
    Strategy.prototype.authenticate = function(req, options) {
      var user = { id: '1', username: 'jaredhanson' };
  ...
  describe('success with flash message and type set by strategy', function() {
    function Strategy() {
    }
    Strategy.prototype.authenticate = function(req, options) {
      var user = { id: '1', username: 'jaredhanson' };
