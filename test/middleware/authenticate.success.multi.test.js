...
describe('middleware/authenticate', function() {
  ...
  describe('with multiple strategies provided directly, the first of which succeeds', function() {
    function StrategyA() {
    }
    StrategyA.prototype.authenticate = function(req) {
      this.success({ username: 'bob-a' });
    ...
    before(function(done) {
      chai.connect.use(authenticate(passport, [new StrategyA(), new StrategyB()]))
        .req(function(req) {
          request = req;
  ...
  describe('with multiple strategies provided directly, the second of which succeeds', function() {
    function StrategyA() {
    }
    StrategyA.prototype.authenticate = function(req) {
      this.fail('A challenge');
